...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l7: if (  ( ((*in)._control.Consumer == 0) ) )
        {
            l8: if (  ( ((*in)._control.Receiver == 1) )  &&  ( (((*in).Receiver.value == (((*in).Receiver.recseq + 1) % 3))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l9: if (  ( ((*in)._control.Receiver == 2) )  &&  ( ((((*in).Receiver.sent != (2 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 3) ] == 1))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l22: if (  ( ((*in)._control.Medium == 0) ) )
        {
            ...
            l24: if (  ( ((*in)._control.Sender == 4) )  &&  ( (((((*in).Sender.rack + 1) % 3) != (*in).Sender.sendseq)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l30: if (  ( ((*in)._control.Receiver == 5) )  &&  ( (((*in).Receiver.i == 3)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l36: if (  ( ((*in)._control.Sender == 4) ) )
        {
            l37: if (  ( (((((*in).Sender.rack + 1) % 3) == (*in).Sender.sendseq)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l38: if (  ( ((*in)._control.Sender == 0) ) )
        {
            ...
            l42: if (  ( (((((*in).Sender.rack + 2) % 3) > (*in).Sender.sendseq)) )  &&  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l45: if (  ( ((*in)._control.Receiver == 1) ) )
        {
            l46: if (  ( (((*in).Receiver.value != (((*in).Receiver.recseq + 1) % 3))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l47: if (  ( ((*in)._control.Receiver == 5) ) )
        {
            l48: if (  ( (((*in).Receiver.i < 3)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l49: if (  ( ((*in)._control.Receiver == 2) ) )
        {
            l50: if (  ( ((((*in).Receiver.sent != (2 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 3) ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
