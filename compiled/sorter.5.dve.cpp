...
struct state_struct_t
{
    ...
    __attribute__((__packed__)) LongBrick1;
    struct
    {
        uint8_t location;
        uint8_t position;
...
int get_initial( const cesmi_setup *setup, int handle, cesmi_node *out ){
    ...
    *out = setup->make_node( setup, state_size );
    ...
    _out.LongBrick1.location = 0;
    _out.LongBrick1.position = 0;
    _out._control.LongBrick1 = 0;
...
int get_successor0( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l41: if (  ( ((*in)._control.LongBrick1 == 0) ) )
        {
            l42: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 0) && ((*in).put_long_brick == 0)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 43;
            }
            l43: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 0) && ((*in).put_long_brick == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                ...
                ((*out).LongBrick1.location) = (1);
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 44;
            }
            l44: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).belt1_moving == 1) && (((*in).LongBrick1.position == 0) || ((((*in).LongBrick1.position > 1) && ((*in).LongBrick1.position < 5)) || (((*in).LongBrick1.position > 5) && ((*in).LongBrick1.position < 8)))))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).LongBrick1.position) = (((*out).LongBrick1.position + 1));
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 45;
            }
            l45: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).belt1_moving == 1) && ((*in).LongBrick1.position == 1))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l46: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).belt1_moving == 1) && ((*in).LongBrick1.position == 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l47: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && ((((*in).LongBrick1.position >= 8) && ((*in).LongBrick1.position <= 10)) && (((*in).arm_kicking == 0) && ((*in).belt1_moving == 1)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l48: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).LongBrick1.position == 11) && (((*in).arm_kicking == 0) && ((*in).belt1_moving == 1)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).LongBrick1.location) = (2);
                ((*out).LongBrick1.position) = (3);
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 49;
            }
            l49: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).belt1_moving == 0) && ((*in).LongBrick1.position < 8))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l50: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).belt1_moving == 0) && ((((*in).LongBrick1.position >= 8) || ((*in).LongBrick1.position == 11)) && ((*in).arm_kicking == 0)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l51: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 1) && (((*in).LongBrick1.position >= 8) && ((*in).arm_kicking == 1))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).LongBrick1.location) = (3);
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 52;
            }
            l52: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 2) && (((*in).belt2_moving == 1) && ((*in).LongBrick1.position < 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l53: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 2) && (((*in).belt2_moving == 2) && ((*in).LongBrick1.position > 0))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l54: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 2) && ((*in).belt2_moving == 0)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l55: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 2) && (((*in).belt2_moving == 1) && ((*in).LongBrick1.position == 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).LongBrick1.location) = (4);
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 56;
            }
            l56: if (  ( ((((*in).token == 6) && (((*in).LongBrick1.location == 2) && (((*in).belt2_moving == 2) && ((*in).LongBrick1.position == 0))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.LongBrick1 = 0;
                ((*out).LongBrick1.location) = (5);
                ((*out).token) = (7);
                system_in_deadlock = false;
                *to = blob_out;
                return 57;
            }
            l57: if (  ( ((((*in).LongBrick1.location == 5) || (((*in).LongBrick1.location == 4) || ((*in).LongBrick1.location == 3)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
