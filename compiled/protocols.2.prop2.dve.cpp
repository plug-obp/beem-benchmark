...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l5: if (  ( ((*in)._control.channel_K == 1) ) )
        {
            l6: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l7: if (  ( ((*in)._control.channel_L == 0) ) )
        {
            l8: if (  ( ((*in)._control.Receiver == 0) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l9: if (  ( ((*in)._control.channel_L == 1) ) )
        {
            l10: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l14: if (  ( ((*in)._control.Consumer == 2) ) )
        {
            l15: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l18: if (  ( ((*in)._control.Consumer == 1) ) )
        {
            l19: if (  ( (((*in).Consumer.value == 0)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l20: if (  ( (((*in).Consumer.value == 1)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l21: if (  ( ((*in)._control.Consumer == 0) ) )
        {
            l22: if (  ( ((*in)._control.Receiver == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l23: if (  ( ((*in)._control.Sender == 0) ) )
        {
            l24: if (  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l25: if (  ( ((*in)._control.Producer == 2) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l26: if (  ( ((*in)._control.Sender == 1) ) )
        {
            l27: if (  ( ((*in)._control.channel_L == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l28: if (  ( ((*in)._control.Sender == 2) ) )
        {
            l29: if (  ( (((*in).Sender.ack != (*in).Sender.sab)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l30: if (  ( (((*in).Sender.ack == (*in).Sender.sab)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l31: if (  ( ((*in)._control.Receiver == 0) ) )
        {
            l32: if (  ( ((*in)._control.channel_K == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
    ...
    l33: if (  ( system_in_deadlock ) )
    {
        l34: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
        {
            cesmi_node blob_out = setup->make_node( setup, state_size );
            state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
            *out = *in;
