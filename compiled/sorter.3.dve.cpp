...
struct state_struct_t
{
    ...
    __attribute__((__packed__)) ShortBrick2;
}
...
int get_initial( const cesmi_setup *setup, int handle, cesmi_node *out ){
    ...
    *out = setup->make_node( setup, state_size );
    ...
    _out.ShortBrick2.location = 0;
    _out.ShortBrick2.position = 0;
    _out._control.ShortBrick2 = 0;
    return 2;
}
...
int get_successor0( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l58: if (  ( ((*in)._control.ShortBrick2 == 0) ) )
        {
            l59: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 0) && ((*in).put_short_brick == 0)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 60;
            }
            l60: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 0) && ((*in).put_short_brick == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).put_short_brick) = (0);
                ((*out).ShortBrick2.location) = (1);
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 61;
            }
            l61: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && ((((*in).ShortBrick2.position < 3) || (((*in).ShortBrick2.position == 4) || (((*in).ShortBrick2.position > 5) && ((*in).ShortBrick2.position < 10)))) && ((*in).belt1_moving == 1))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).ShortBrick2.position) = (((*out).ShortBrick2.position + 1));
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 62;
            }
            l62: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).belt1_moving == 1) && ((*in).ShortBrick2.position == 3))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l63: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).belt1_moving == 1) && ((*in).ShortBrick2.position == 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l64: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).ShortBrick2.position == 10) && (((*in).arm_kicking == 0) && ((*in).belt1_moving == 1)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l65: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).ShortBrick2.position == 11) && (((*in).arm_kicking == 0) && ((*in).belt1_moving == 1)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).ShortBrick2.location) = (2);
                ((*out).ShortBrick2.position) = (3);
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 66;
            }
            l66: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).belt1_moving == 0) && ((*in).ShortBrick2.position < 10))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l67: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && (((*in).belt1_moving == 0) && ((((*in).ShortBrick2.position == 10) || ((*in).ShortBrick2.position == 11)) && ((*in).arm_kicking == 0)))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l68: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 1) && ((((*in).ShortBrick2.position == 10) || ((*in).ShortBrick2.position == 11)) && ((*in).arm_kicking == 1))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).ShortBrick2.location) = (3);
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 69;
            }
            l69: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 2) && (((*in).belt2_moving == 1) && ((*in).ShortBrick2.position < 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l70: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 2) && (((*in).belt2_moving == 2) && ((*in).ShortBrick2.position > 0))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l71: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 2) && ((*in).belt2_moving == 0)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l72: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 2) && (((*in).belt2_moving == 1) && ((*in).ShortBrick2.position == 5))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).ShortBrick2.location) = (4);
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 73;
            }
            l73: if (  ( ((((*in).token == 7) && (((*in).ShortBrick2.location == 2) && (((*in).belt2_moving == 2) && ((*in).ShortBrick2.position == 0))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.ShortBrick2 = 0;
                ((*out).ShortBrick2.location) = (5);
                ((*out).token) = (0);
                system_in_deadlock = false;
                *to = blob_out;
                return 74;
            }
            l74: if (  ( ((((*in).ShortBrick2.location == 5) || (((*in).ShortBrick2.location == 4) || ((*in).ShortBrick2.location == 3)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
