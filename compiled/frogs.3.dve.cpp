...
int get_successor0( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l8: if (  ( ((*in)._control.Frog == 0) ) )
        {
            ...
            l10: if (  ( ((((*in).y < (31 - 1)) && ((*in).a[ ((((*in).y + 1) * 1) + (*in).x) ] == 2))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l12: if (  ( ((((*in).y < (31 - 2)) && (((*in).a[ ((((*in).y + 1) * 1) + (*in).x) ] == 1) && ((*in).a[ ((((*in).y + 2) * 1) + (*in).x) ] == 2)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l14: if (  ( ((((*in).a[ 0 ] == 2) && (((*in).a[ 1 ] == 2) && (((*in).a[ 2 ] == 2) && (((*in).a[ 3 ] == 2) && (((*in).a[ 4 ] == 2) && (((*in).a[ 5 ] == 2) && (((*in).a[ 6 ] == 2) && (((*in).a[ 7 ] == 2) && (((*in).a[ 8 ] == 2) && (((*in).a[ 9 ] == 2) && (((*in).a[ 10 ] == 2) && (((*in).a[ 11 ] == 2) && (((*in).a[ 12 ] == 2) && (((*in).a[ 13 ] == 2) && (((*in).a[ 14 ] == 2) && (((*in).a[ 16 ] == 1) && (((*in).a[ 17 ] == 1) && (((*in).a[ 18 ] == 1) && (((*in).a[ 19 ] == 1) && (((*in).a[ 20 ] == 1) && (((*in).a[ 21 ] == 1) && (((*in).a[ 22 ] == 1) && (((*in).a[ 23 ] == 1) && (((*in).a[ 24 ] == 1) && (((*in).a[ 25 ] == 1) && (((*in).a[ 26 ] == 1) && (((*in).a[ 27 ] == 1) && (((*in).a[ 28 ] == 1) && (((*in).a[ 29 ] == 1) && ((*in).a[ 30 ] == 1))))))))))))))))))))))))))))))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
