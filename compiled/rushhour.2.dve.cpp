...
int get_successor0( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        {
            l4: if (  ( ((((*in).Red_car.x > 0) && ((*in).A[ (((*in).Red_car.y * 6) + ((*in).Red_car.x - 1)) ] == 0))) ) )
            {
            ...
            l5: if (  ( (((((*in).Red_car.x + (*in).Red_car.length) < 6) && ((*in).A[ (((*in).Red_car.y * 6) + ((*in).Red_car.x + (*in).Red_car.length)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l8: if (  ( ((((*in).Car_hor_1.x > 0) && ((*in).A[ (((*in).Car_hor_1.y * 6) + ((*in).Car_hor_1.x - 1)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l9: if (  ( (((((*in).Car_hor_1.x + (*in).Car_hor_1.length) < 6) && ((*in).A[ (((*in).Car_hor_1.y * 6) + ((*in).Car_hor_1.x + (*in).Car_hor_1.length)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l11: if (  ( ((((*in).Car_hor_2.x > 0) && ((*in).A[ (((*in).Car_hor_2.y * 6) + ((*in).Car_hor_2.x - 1)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.Car_hor_2 = 0;
                ((*out).A[ (((*out).Car_hor_2.y * 6) + ((*out).Car_hor_2.x + ((*out).Car_hor_2.length - 1))) ]) = (0);
                ((*out).A[ (((*out).Car_hor_2.y * 6) + ((*out).Car_hor_2.x - 1)) ]) = (1);
                ((*out).Car_hor_2.x) = (((*out).Car_hor_2.x - 1));
                system_in_deadlock = false;
                *to = blob_out;
                return 12;
            }
            l12: if (  ( (((((*in).Car_hor_2.x + (*in).Car_hor_2.length) < 6) && ((*in).A[ (((*in).Car_hor_2.y * 6) + ((*in).Car_hor_2.x + (*in).Car_hor_2.length)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.Car_hor_2 = 0;
                ((*out).A[ (((*out).Car_hor_2.y * 6) + (*out).Car_hor_2.x) ]) = (0);
                ((*out).A[ (((*out).Car_hor_2.y * 6) + ((*out).Car_hor_2.x + (*out).Car_hor_2.length)) ]) = (1);
                ((*out).Car_hor_2.x) = (((*out).Car_hor_2.x + 1));
                system_in_deadlock = false;
                *to = blob_out;
                return 13;
        ...
        {
            l14: if (  ( ((((*in).Car_hor_3.x > 0) && ((*in).A[ (((*in).Car_hor_3.y * 6) + ((*in).Car_hor_3.x - 1)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l15: if (  ( (((((*in).Car_hor_3.x + (*in).Car_hor_3.length) < 6) && ((*in).A[ (((*in).Car_hor_3.y * 6) + ((*in).Car_hor_3.x + (*in).Car_hor_3.length)) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l25: if (  ( ((*in)._control.Car_ver_4 == 0) ) )
        {
            l26: if (  ( ((((*in).Car_ver_4.y > 0) && ((*in).A[ ((((*in).Car_ver_4.y - 1) * 6) + (*in).Car_ver_4.x) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.Car_ver_4 = 0;
                ((*out).A[ ((((*out).Car_ver_4.y + ((*out).Car_ver_4.length - 1)) * 6) + (*out).Car_ver_4.x) ]) = (0);
                ((*out).A[ ((((*out).Car_ver_4.y - 1) * 6) + (*out).Car_ver_4.x) ]) = (1);
                ((*out).Car_ver_4.y) = (((*out).Car_ver_4.y - 1));
                system_in_deadlock = false;
                *to = blob_out;
                return 27;
            }
            l27: if (  ( (((((*in).Car_ver_4.y + (*in).Car_ver_4.length) < 6) && ((*in).A[ ((((*in).Car_ver_4.y + (*in).Car_ver_4.length) * 6) + (*in).Car_ver_4.x) ] == 0))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.Car_ver_4 = 0;
                ((*out).A[ (((*out).Car_ver_4.y * 6) + (*out).Car_ver_4.x) ]) = (0);
                ((*out).A[ ((((*out).Car_ver_4.y + (*out).Car_ver_4.length) * 6) + (*out).Car_ver_4.x) ]) = (1);
                ((*out).Car_ver_4.y) = (((*out).Car_ver_4.y + 1));
                system_in_deadlock = false;
                *to = blob_out;
                return 28;
