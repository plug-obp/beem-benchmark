...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l11: if (  ( ((*in)._control.Consumer == 0) ) )
        {
            ...
            l15: if (  ( ((*in)._control.Receiver == 2) )  &&  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 1))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l16: if (  ( ((*in)._control.Receiver == 2) )  &&  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 1))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l17: if (  ( ((*in)._control.Receiver == 2) )  &&  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 1))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l42: if (  ( ((*in)._control.Medium == 0) ) )
        {
            ...
            l52: if (  ( ((*in)._control.Receiver == 2) )  &&  ( (((*in).Receiver.sent == (3 / 2))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l53: if (  ( ((*in)._control.Receiver == 2) )  &&  ( (((*in).Receiver.sent == (3 / 2))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l54: if (  ( ((*in)._control.Receiver == 2) )  &&  ( (((*in).Receiver.sent == (3 / 2))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l82: if (  ( ((*in)._control.Sender == 0) ) )
        {
            ...
            l92: if (  ( (((((*in).Sender.rack + 3) % 10) > (*in).Sender.sendseq)) )  &&  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l93: if (  ( (((((*in).Sender.rack + 3) % 10) > (*in).Sender.sendseq)) )  &&  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l94: if (  ( (((((*in).Sender.rack + 3) % 10) > (*in).Sender.sendseq)) )  &&  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l108: if (  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l109: if (  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l110: if (  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 0))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
