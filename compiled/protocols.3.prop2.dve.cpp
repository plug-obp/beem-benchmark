...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        l3: if (  ( ((*in)._control.channel_K == 0) ) )
        {
            ...
            l5: if (  ( ((*in)._control.Sender == 2) )  &&  ( (((*in).Sender.retry < 5)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l6: if (  ( ((*in)._control.channel_K == 1) ) )
        {
            l7: if (  ( (((*in).channel_K.lost < 0)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l10: if (  ( ((*in)._control.channel_L == 1) ) )
        {
            l11: if (  ( (((*in).channel_L.lost < 0)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l27: if (  ( ((*in)._control.Sender == 2) ) )
        {
            ...
            l29: if (  ( (((*in).Sender.retry == 5)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
