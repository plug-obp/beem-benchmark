...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        l3: if (  ( ((*in)._control.AP == 0) ) )
        {
            ...
            l16: if (  ( (((*in).AP.no_ap_ints < 7)) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( ((((*in).sleeping == 0) && (((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l17: if (  ( (((*in).AP.no_ap_ints < 7)) )  &&  ( ((*in)._control.LTL_property == 2) )  &&  ( ((((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l18: if (  ( (((*in).AP.no_ap_ints < 7)) )  &&  ( ((*in)._control.LTL_property == 2) )  &&  ( ((!(((*in).sleeping == 0) ) && (((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l160: if (  ( ((*in)._control.Interrupt_Generator == 0) ) )
        {
            ...
            l163: if (  ( ((((*in).enabled_lsl_interrupt == 1) && ((*in).Interrupt_Generator.no_lsl_ints < 7))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( ((((*in).sleeping == 0) && (((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l164: if (  ( ((((*in).enabled_lsl_interrupt == 1) && ((*in).Interrupt_Generator.no_lsl_ints < 7))) )  &&  ( ((*in)._control.LTL_property == 2) )  &&  ( ((((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l165: if (  ( ((((*in).enabled_lsl_interrupt == 1) && ((*in).Interrupt_Generator.no_lsl_ints < 7))) )  &&  ( ((*in)._control.LTL_property == 2) )  &&  ( ((!(((*in).sleeping == 0) ) && (((*in).lsl_interrupt == 1) || ((*in).ap_interrupt == 1)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
