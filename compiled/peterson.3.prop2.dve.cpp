...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l15: if (  ( ((*in)._control.P_0 == 4) ) )
        {
            ...
            l20: if (  ( ((((*in).pos[ ((*in).P_0.j - 1) ] != 0) || ((*in).P_0.k == 3))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.P_0 == 2)) || ((((*in)._control.P_0 == 3)) || (((*in)._control.P_0 == 4)))) && !((((*in)._control.P_0 == 1)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l41: if (  ( ((*in)._control.P_1 == 4) ) )
        {
            ...
            l46: if (  ( ((((*in).pos[ ((*in).P_1.j - 1) ] != 1) || ((*in).P_1.k == 3))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.P_0 == 2)) || ((((*in)._control.P_0 == 3)) || (((*in)._control.P_0 == 4)))) && !((((*in)._control.P_0 == 1)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l67: if (  ( ((*in)._control.P_2 == 4) ) )
        {
            ...
            l72: if (  ( ((((*in).pos[ ((*in).P_2.j - 1) ] != 2) || ((*in).P_2.k == 3))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.P_0 == 2)) || ((((*in)._control.P_0 == 3)) || (((*in)._control.P_0 == 4)))) && !((((*in)._control.P_0 == 1)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
