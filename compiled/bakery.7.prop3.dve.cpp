...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l11: if (  ( ((*in)._control.P_0 == 1) ) )
        {
            ...
            l19: if (  ( ((((*in).P_0.j == 4) && ((*in).P_0.max < 12))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.P_0 == 4)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l40: if (  ( ((*in)._control.P_1 == 1) ) )
        {
            ...
            l48: if (  ( ((((*in).P_1.j == 4) && ((*in).P_1.max < 12))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.P_0 == 4)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l69: if (  ( ((*in)._control.P_2 == 1) ) )
        {
            ...
            l77: if (  ( ((((*in).P_2.j == 4) && ((*in).P_2.max < 12))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.P_0 == 4)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l98: if (  ( ((*in)._control.P_3 == 1) ) )
        {
            ...
            l106: if (  ( ((((*in).P_3.j == 4) && ((*in).P_3.max < 12))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.P_0 == 4)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
