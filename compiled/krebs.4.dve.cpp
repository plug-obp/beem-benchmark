...
int get_initial( const cesmi_setup *setup, int handle, cesmi_node *out ){
    ...
    *out = setup->make_node( setup, state_size );
    ...
    _out._control.krebs_1 = 0;
    _out._control.krebs_2 = 0;
    ...
    else
    {
        ...
        l19: if (  ( ((*in)._control.krebs_1 == 1) ) )
        {
            l20: if ( true )
            {
                ...
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.krebs_1 = 2;
                system_in_deadlock = false;
                *to = blob_out;
                return 21;
            }
        }
        l21: if (  ( ((*in)._control.krebs_1 == 6) ) )
        {
            l22: if (  ( (((*in).H20 >= 1)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
        ...
        l27: if (  ( ((*in)._control.krebs_1 == 0) ) )
        {
            l28: if (  ( ((((*in).acetyl_co_a >= 1) && ((*in).H20 >= 1))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.krebs_1 = 1;
                ((*out).acetyl_co_a) = (((*out).acetyl_co_a - 1));
                ((*out).H20) = (((*out).H20 - 1));
                system_in_deadlock = false;
                *to = blob_out;
        ...
        l31: if (  ( ((*in)._control.krebs_2 == 1) ) )
        {
            l32: if ( true )
            {
                ...
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.krebs_2 = 2;
                system_in_deadlock = false;
                *to = blob_out;
                return 33;
            }
        }
        l33: if (  ( ((*in)._control.krebs_2 == 6) ) )
        {
            l34: if (  ( (((*in).H20 >= 1)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
        ...
        l39: if (  ( ((*in)._control.krebs_2 == 0) ) )
        {
            l40: if (  ( ((((*in).acetyl_co_a >= 1) && ((*in).H20 >= 1))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
                (*out)._control.krebs_2 = 1;
                ((*out).acetyl_co_a) = (((*out).acetyl_co_a - 1));
                ((*out).H20) = (((*out).H20 - 1));
                system_in_deadlock = false;
                *to = blob_out;
        ...
        l43: if (  ( ((*in)._control.ETS == 0) ) )
        {
            l44: if (  ( (((*in).ADP >= 2)) )  &&  ( ((*in)._control.glykolyza == 0) )  &&  ( ((((*in).NADH >= 1) && (((*in).O2 >= 1) && ((*in).Hp >= 2)))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l45: if (  ( ((*in)._control.rest_of_cell == 0) ) )
        {
            l46: if (  ( (((*in).ATP >= 1)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
