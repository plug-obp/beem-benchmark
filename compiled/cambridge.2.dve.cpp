...
int get_successor0( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l56: if (  ( ((*in)._control.StoR == 0) ) )
        {
            ...
            l63: if (  ( (!(((*in).StoR.buf_act == 3) )) )  &&  ( ((*in)._control.Sender == 8) )  &&  ( (((*in).Sender.m == (*in).Sender.n)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l64: if (  ( (!(((*in).StoR.buf_act == 3) )) )  &&  ( ((*in)._control.Sender == 7) )  &&  ( (((*in).Sender.m == (*in).Sender.n)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l65: if (  ( (!(((*in).StoR.buf_act == 3) )) )  &&  ( ((*in)._control.Sender == 3) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l68: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l69: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 1) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l70: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 4) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l71: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 5) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l72: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l73: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 3) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l74: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 4) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l75: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 5) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l76: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 7) )  &&  ( (((((*in).Receiver.m + 1) % 4) == (*in).Receiver.n)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l77: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 3) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l78: if (  ( (!(((*in).RtoS.buf_act == 3) )) )  &&  ( ((*in)._control.Receiver == 8) )  &&  ( (((((*in).Receiver.m + 1) % 4) == (*in).Receiver.n)) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
