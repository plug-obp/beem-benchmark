...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l5: if (  ( ((*in)._control.channel_K == 1) ) )
        {
            l6: if (  ( (((*in).channel_K.lost < 3)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l8: if (  ( ((*in)._control.channel_L == 1) ) )
        {
            l9: if (  ( (((*in).channel_L.lost < 3)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l10: if (  ( ((*in)._control.Producer == 0) ) )
        {
            l11: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l12: if (  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l17: if (  ( ((*in)._control.Consumer == 1) ) )
        {
            l18: if (  ( (((*in).Consumer.value == 0)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l19: if (  ( (((*in).Consumer.value == 1)) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l20: if (  ( ((*in)._control.Consumer == 0) ) )
        {
            l21: if (  ( ((*in)._control.Receiver == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l22: if (  ( ((*in)._control.Sender == 0) ) )
        {
            l23: if (  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l24: if (  ( ((*in)._control.Producer == 2) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l25: if (  ( ((*in)._control.Receiver == 0) ) )
        {
            l26: if (  ( ((*in)._control.channel_K == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((!((((*in)._control.Consumer == 2)) ) && !((((*in)._control.Consumer == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
