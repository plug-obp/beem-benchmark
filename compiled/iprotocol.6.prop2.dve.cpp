...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        ...
        l7: if (  ( ((*in)._control.Consumer == 0) ) )
        {
            ...
            l9: if (  ( ((*in)._control.Receiver == 2) )  &&  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 1))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l22: if (  ( ((*in)._control.Medium == 0) ) )
        {
            ...
            l26: if (  ( ((*in)._control.Receiver == 2) )  &&  ( (((*in).Receiver.sent == (3 / 2))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l38: if (  ( ((*in)._control.Sender == 0) ) )
        {
            ...
            l42: if (  ( (((((*in).Sender.rack + 3) % 10) > (*in).Sender.sendseq)) )  &&  ( ((*in)._control.Producer == 1) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        l49: if (  ( ((*in)._control.Receiver == 2) ) )
        {
            l50: if (  ( ((((*in).Receiver.sent != (3 / 2)) && ((*in).Receiver.recbuf[ (((*in).Receiver.recseq + 1) % 10) ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (!((((*in)._control.Consumer == 1)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
