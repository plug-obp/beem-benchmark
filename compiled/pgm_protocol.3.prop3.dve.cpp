...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        l3: if (  ( ((*in)._control.sender == 0) ) )
        {
            ...
            l5: if (  ( (((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9)))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.receiver == 6)) && (((*in).RXW_LEAD + 1) == 3)) && !(((((*in)._control.sender == 1)) && ((*in).packet == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l6: if (  ( (((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9)))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!(((((*in)._control.sender == 1)) && ((*in).packet == 3)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l10: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && (((*in).TXW_TRAIL < ((*in).TXW_LEAD + 1)) && (((*in).TXW_LEAD == 9) && ((*in).x >= 9)))))))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l11: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && (((*in).TXW_TRAIL < ((*in).TXW_LEAD + 1)) && (((*in).TXW_LEAD == 9) && ((*in).x >= 9)))))))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.receiver == 6)) && (((*in).RXW_LEAD + 1) == 3)) && !(((((*in)._control.sender == 1)) && ((*in).packet == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l12: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && (((*in).TXW_TRAIL < ((*in).TXW_LEAD + 1)) && (((*in).TXW_LEAD == 9) && ((*in).x >= 9)))))))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!(((((*in)._control.sender == 1)) && ((*in).packet == 3)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l13: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && !(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ))))) )  &&  ( ((*in)._control.NS == 2) )  &&  ( ((!(((*in).NS_size == 0) ) && ((*in).NS_time[ 0 ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l14: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && !(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ))))) )  &&  ( ((*in)._control.NS == 2) )  &&  ( ((!(((*in).NS_size == 0) ) && ((*in).NS_time[ 0 ] == 0))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.receiver == 6)) && (((*in).RXW_LEAD + 1) == 3)) && !(((((*in)._control.sender == 1)) && ((*in).packet == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l15: if (  ( ((!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && !(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ))))) )  &&  ( ((*in)._control.NS == 2) )  &&  ( ((!(((*in).NS_size == 0) ) && ((*in).NS_time[ 0 ] == 0))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!(((((*in)._control.sender == 1)) && ((*in).packet == 3)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
        ...
        {
            l21: if (  ( ((((*in).x < 9) && (!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && ((((*in)._control.sender == 0)) && ((((*in)._control.element == 0)) && ((((*in)._control.receiver == 0)) && ((((*in).SN_size < 1) || ((*in).SN_time[ 0 ] > 0)) && ((((*in).SN_size < 2) || ((*in).SN_time[ 1 ] > 0)) && ((((*in).SN_size < 3) || ((*in).SN_time[ 2 ] > 0)) && ((((*in).SN_size < 4) || ((*in).SN_time[ 3 ] > 0)) && ((((*in).SN_size < 5) || ((*in).SN_time[ 4 ] > 0)) && ((((*in).SN_size < 6) || ((*in).SN_time[ 5 ] > 0)) && ((((*in).SN_size < 7) || ((*in).SN_time[ 6 ] > 0)) && ((((*in).NS_size < 1) || ((*in).NS_time[ 0 ] > 0)) && ((((*in).NS_size < 2) || ((*in).NS_time[ 1 ] > 0)) && ((((*in).NS_size < 3) || ((*in).NS_time[ 2 ] > 0)) && ((((*in).NS_size < 4) || ((*in).NS_time[ 3 ] > 0)) && ((((*in).NS_size < 5) || ((*in).NS_time[ 4 ] > 0)) && ((((*in).NS_size < 6) || ((*in).NS_time[ 5 ] > 0)) && ((((*in).NS_size < 7) || ((*in).NS_time[ 6 ] > 0)) && ((((*in).RN_size < 1) || ((*in).RN_time[ 0 ] > 0)) && ((((*in).RN_size < 2) || ((*in).RN_time[ 1 ] > 0)) && ((((*in).RN_size < 3) || ((*in).RN_time[ 2 ] > 0)) && ((((*in).RN_size < 4) || ((*in).RN_time[ 3 ] > 0)) && ((((*in).RN_size < 5) || ((*in).RN_time[ 4 ] > 0)) && ((((*in).RN_size < 6) || ((*in).RN_time[ 5 ] > 0)) && ((((*in).RN_size < 7) || ((*in).RN_time[ 6 ] > 0)) && ((((*in).NR_size < 1) || ((*in).NR_time[ 0 ] > 0)) && ((((*in).NR_size < 2) || ((*in).NR_time[ 1 ] > 0)) && ((((*in).NR_size < 3) || ((*in).NR_time[ 2 ] > 0)) && ((((*in).NR_size < 4) || ((*in).NR_time[ 3 ] > 0)) && ((((*in).NR_size < 5) || ((*in).NR_time[ 4 ] > 0)) && ((((*in).NR_size < 6) || ((*in).NR_time[ 5 ] > 0)) && ((((*in).NR_size < 7) || ((*in).NR_time[ 6 ] > 0)) && ((((*in)._control.SN == 6)) && ((((*in)._control.NS == 2)) && ((((*in)._control.RN == 2)) && (((*in)._control.NR == 6)))))))))))))))))))))))))))))))))))))))))) )  &&  ( ((*in)._control.LTL_property == 0) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l22: if (  ( ((((*in).x < 9) && (!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && ((((*in)._control.sender == 0)) && ((((*in)._control.element == 0)) && ((((*in)._control.receiver == 0)) && ((((*in).SN_size < 1) || ((*in).SN_time[ 0 ] > 0)) && ((((*in).SN_size < 2) || ((*in).SN_time[ 1 ] > 0)) && ((((*in).SN_size < 3) || ((*in).SN_time[ 2 ] > 0)) && ((((*in).SN_size < 4) || ((*in).SN_time[ 3 ] > 0)) && ((((*in).SN_size < 5) || ((*in).SN_time[ 4 ] > 0)) && ((((*in).SN_size < 6) || ((*in).SN_time[ 5 ] > 0)) && ((((*in).SN_size < 7) || ((*in).SN_time[ 6 ] > 0)) && ((((*in).NS_size < 1) || ((*in).NS_time[ 0 ] > 0)) && ((((*in).NS_size < 2) || ((*in).NS_time[ 1 ] > 0)) && ((((*in).NS_size < 3) || ((*in).NS_time[ 2 ] > 0)) && ((((*in).NS_size < 4) || ((*in).NS_time[ 3 ] > 0)) && ((((*in).NS_size < 5) || ((*in).NS_time[ 4 ] > 0)) && ((((*in).NS_size < 6) || ((*in).NS_time[ 5 ] > 0)) && ((((*in).NS_size < 7) || ((*in).NS_time[ 6 ] > 0)) && ((((*in).RN_size < 1) || ((*in).RN_time[ 0 ] > 0)) && ((((*in).RN_size < 2) || ((*in).RN_time[ 1 ] > 0)) && ((((*in).RN_size < 3) || ((*in).RN_time[ 2 ] > 0)) && ((((*in).RN_size < 4) || ((*in).RN_time[ 3 ] > 0)) && ((((*in).RN_size < 5) || ((*in).RN_time[ 4 ] > 0)) && ((((*in).RN_size < 6) || ((*in).RN_time[ 5 ] > 0)) && ((((*in).RN_size < 7) || ((*in).RN_time[ 6 ] > 0)) && ((((*in).NR_size < 1) || ((*in).NR_time[ 0 ] > 0)) && ((((*in).NR_size < 2) || ((*in).NR_time[ 1 ] > 0)) && ((((*in).NR_size < 3) || ((*in).NR_time[ 2 ] > 0)) && ((((*in).NR_size < 4) || ((*in).NR_time[ 3 ] > 0)) && ((((*in).NR_size < 5) || ((*in).NR_time[ 4 ] > 0)) && ((((*in).NR_size < 6) || ((*in).NR_time[ 5 ] > 0)) && ((((*in).NR_size < 7) || ((*in).NR_time[ 6 ] > 0)) && ((((*in)._control.SN == 6)) && ((((*in)._control.NS == 2)) && ((((*in)._control.RN == 2)) && (((*in)._control.NR == 6)))))))))))))))))))))))))))))))))))))))))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( ((((((*in)._control.receiver == 6)) && (((*in).RXW_LEAD + 1) == 3)) && !(((((*in)._control.sender == 1)) && ((*in).packet == 3)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l23: if (  ( ((((*in).x < 9) && (!(((*in).close && (((*in).TXW_LEAD == 9) && ((*in).TXW_TRAIL == ((*in).TXW_LEAD + 1)))) ) && (!(((*in).sqn <= (*in).TXW_LEAD) ) && (!(((*in).c >= 3) ) && (!(((((*in).TXW_LEAD - ((*in).TXW_TRAIL + 1)) <= 4) && (((*in).TXW_LEAD < 9) && ((*in).x >= 9))) ) && ((((*in)._control.sender == 0)) && ((((*in)._control.element == 0)) && ((((*in)._control.receiver == 0)) && ((((*in).SN_size < 1) || ((*in).SN_time[ 0 ] > 0)) && ((((*in).SN_size < 2) || ((*in).SN_time[ 1 ] > 0)) && ((((*in).SN_size < 3) || ((*in).SN_time[ 2 ] > 0)) && ((((*in).SN_size < 4) || ((*in).SN_time[ 3 ] > 0)) && ((((*in).SN_size < 5) || ((*in).SN_time[ 4 ] > 0)) && ((((*in).SN_size < 6) || ((*in).SN_time[ 5 ] > 0)) && ((((*in).SN_size < 7) || ((*in).SN_time[ 6 ] > 0)) && ((((*in).NS_size < 1) || ((*in).NS_time[ 0 ] > 0)) && ((((*in).NS_size < 2) || ((*in).NS_time[ 1 ] > 0)) && ((((*in).NS_size < 3) || ((*in).NS_time[ 2 ] > 0)) && ((((*in).NS_size < 4) || ((*in).NS_time[ 3 ] > 0)) && ((((*in).NS_size < 5) || ((*in).NS_time[ 4 ] > 0)) && ((((*in).NS_size < 6) || ((*in).NS_time[ 5 ] > 0)) && ((((*in).NS_size < 7) || ((*in).NS_time[ 6 ] > 0)) && ((((*in).RN_size < 1) || ((*in).RN_time[ 0 ] > 0)) && ((((*in).RN_size < 2) || ((*in).RN_time[ 1 ] > 0)) && ((((*in).RN_size < 3) || ((*in).RN_time[ 2 ] > 0)) && ((((*in).RN_size < 4) || ((*in).RN_time[ 3 ] > 0)) && ((((*in).RN_size < 5) || ((*in).RN_time[ 4 ] > 0)) && ((((*in).RN_size < 6) || ((*in).RN_time[ 5 ] > 0)) && ((((*in).RN_size < 7) || ((*in).RN_time[ 6 ] > 0)) && ((((*in).NR_size < 1) || ((*in).NR_time[ 0 ] > 0)) && ((((*in).NR_size < 2) || ((*in).NR_time[ 1 ] > 0)) && ((((*in).NR_size < 3) || ((*in).NR_time[ 2 ] > 0)) && ((((*in).NR_size < 4) || ((*in).NR_time[ 3 ] > 0)) && ((((*in).NR_size < 5) || ((*in).NR_time[ 4 ] > 0)) && ((((*in).NR_size < 6) || ((*in).NR_time[ 5 ] > 0)) && ((((*in).NR_size < 7) || ((*in).NR_time[ 6 ] > 0)) && ((((*in)._control.SN == 6)) && ((((*in)._control.NS == 2)) && ((((*in)._control.RN == 2)) && (((*in)._control.NR == 6)))))))))))))))))))))))))))))))))))))))))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!(((((*in)._control.sender == 1)) && ((*in).packet == 3)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
