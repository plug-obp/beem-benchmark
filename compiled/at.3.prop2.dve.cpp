...
int get_successor1( const cesmi_setup *setup, int next_state, cesmi_node from, cesmi_node *to ) 
{
    ...
    else
    {
        l3: if (  ( ((*in)._control.Timer == 0) ) )
        {
            ...
            l5: if (  ( ((((*in).t[ 0 ] != 0) && (((*in).t[ 1 ] != 0) && (((*in).t[ 2 ] != 0) && ((*in).t[ 3 ] != 0))))) )  &&  ( ((*in)._control.LTL_property == 0) )  &&  ( (((((*in)._control.P_0 == 2)) && !((((*in)._control.P_0 == 9)) ))) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
            ...
            l6: if (  ( ((((*in).t[ 0 ] != 0) && (((*in).t[ 1 ] != 0) && (((*in).t[ 2 ] != 0) && ((*in).t[ 3 ] != 0))))) )  &&  ( ((*in)._control.LTL_property == 1) )  &&  ( (!((((*in)._control.P_0 == 9)) )) ) )
            {
                cesmi_node blob_out = setup->make_node( setup, state_size );
                state_struct_t *out = reinterpret_cast< state_struct_t * >( blob_out.memory );
                *out = *in;
